...
-- ── Seed subjects ──────────────────────────────────────────────────────────────
INSERT INTO public.subjects (subject_name, description, is_custom) VALUES
  ('Matematika', NULL, false),
  ('IPA', NULL, false),
  ('IPS', NULL, false),
  ('Bahasa Indonesia', NULL, false),
  ('Bahasa Inggris', NULL, false),
  ('Fisika', NULL, false),
  ('Kimia', NULL, false),
  ('Biologi', NULL, false),
  ('Ekonomi', NULL, false),
  ('Sejarah', NULL, false),
  ('PKN', NULL, false),
  ('Seni Budaya', NULL, false),
  ('PJOK', NULL, false),
  ('Informatika', NULL, false),
  ('Bahasa Daerah', NULL, false),
  ('Agama', NULL, false),
  ('Prakarya', NULL, false),
  ('Geografi', NULL, false),
  ('Sosiologi', NULL, false),
  ('Bahasa Jepang', NULL, false),
  ('Bahasa Arab', NULL, false),
  ('Bahasa Mandarin', NULL, false),
  ('Bahasa Korea', NULL, false),
  ('Bahasa Jerman', NULL, false),
  ('Bahasa Prancis', NULL, false),
  ('Pendidikan Agama dan Budi Pekerti', NULL, false),
  ('Al-Qur''an Hadis', NULL, false),
  ('Akidah Akhlak', NULL, false),
  ('Fikih', NULL, false),
  ('Sejarah Kebudayaan Islam', NULL, false),
  ('Pendidikan Pancasila', NULL, false),
  ('Pendidikan Pancasila dan Kewarganegaraan', NULL, false),
  ('Ilmu Pengetahuan Alam', NULL, false),
  ('Ilmu Pengetahuan Sosial', NULL, false),
  ('Ilmu Pengetahuan Alam dan Sosial', NULL, false),
  ('Pendidikan Jasmani, Olahraga, dan Kesehatan', NULL, false),
  ('Seni Budaya dan Prakarya', NULL, false),
  ('Seni Musik', NULL, false),
  ('Seni Rupa', NULL, false),
  ('Seni Tari', NULL, false),
  ('Seni Teater', NULL, false),
  ('Muatan Lokal', NULL, false),
  ('Bahasa Indonesia Tingkat Lanjut', NULL, false),
  ('Bahasa Inggris Tingkat Lanjut', NULL, false),
  ('Matematika Wajib', NULL, false),
  ('Matematika Peminatan', NULL, false),
  ('Matematika Tingkat Lanjut', NULL, false),
  ('Sejarah Indonesia', NULL, false),
  ('Prakarya dan Kewirausahaan', NULL, false),
  ('Tematik - Tema 1: Indahnya Kebersamaan', 'Indahnya Kebersamaan', false),
  ('Tematik - Tema 2: Selalu Berhemat Energi', 'Selalu Berhemat Energi', false),
  ('Tematik - Tema 3: Peduli Terhadap Makhluk Hidup', 'Peduli Terhadap Makhluk Hidup', false),
  ('Tematik - Tema 4: Berbagai Pekerjaan', 'Berbagai Pekerjaan', false),
  ('Tematik - Tema 5: Pahlawanku', 'Pahlawanku', false),
  ('Tematik - Tema 6: Cita-citaku', 'Cita-citaku', false),
  ('Tematik - Tema 7: Indahnya Keragaman di Negeriku', 'Indahnya Keragaman di Negeriku', false),
  ('Tematik - Tema 8: Daerah Tempat Tinggalku', 'Daerah Tempat Tinggalku', false),
  ('Tematik - Tema 9: Kayanya Negeriku', 'Kayanya Negeriku', false)
